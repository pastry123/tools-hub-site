...
const translations = {
  ...
  ar: {
    ...
    "pdfMerger.subtitle": "دمج ملفات PDF متعددة",
    "pdfMerger.selectFiles": "اختر ملفات PDF",
    "pdfMerger.addFiles": "إضافة ملفات",
    "pdfMerger.mergeFiles": "دمج الملفات",
    "pdfMerger.downloadMerged": "تحميل الملف المدموج",
    "pdfSplitter.title": "تقسيم PDF",
    "pdfSplitter.subtitle": "تقسيم ملف PDF إلى صفحات منفصلة",
    "pdfSplitter.selectPdf": "اختر ملف PDF",
    "pdfSplitter.splitPages": "تقسيم الصفحات",
    "pdfSplitter.downloadPages": "تحميل الصفحات",
    "pdfCompressor.title": "ضغط PDF",
    "pdfCompressor.subtitle": "تقليل حجم ملفات PDF",
    "pdfConverter.title": "محول PDF",
    "pdfConverter.subtitle": "تحويل PDF إلى تنسيقات أخرى",
    "pdfEditor.title": "محرر PDF",
    "pdfEditor.subtitle": "تحرير وتعديل ملفات PDF",

    // Text Processing Tools
    "textTools.title": "أدوات النصوص",
    "textCounter.title": "عداد النصوص",
    "textCounter.subtitle": "عد الكلمات والأحرف والفقرات",
    ...
    "textReplacer.subtitle": "البحث والاستبدال في النصوص",
    ...
    "textDiff.subtitle": "مقارنة واكتشاف الاختلافات بين النصوص",
    ...
    "jsonFormatter.subtitle": "تنسيق والتحقق من صحة JSON",
    ...
    "htmlEncoder.subtitle": "ترميز وفك ترميز HTML",
    "htmlEncoder.encodeHtml": "ترميز HTML",
    "htmlEncoder.decodeHtml": "فك ترميز HTML",
    "cssMinifier.title": "ضاغط CSS",
    "cssMinifier.subtitle": "ضغط وتحسين كود CSS",
    "jsMinifier.title": "ضاغط JavaScript",
    "jsMinifier.subtitle": "ضغط وتحسين كود JavaScript",
    "regexTester.title": "مختبر التعبيرات المنتظمة",
    "regexTester.subtitle": "اختبار وتطوير التعبيرات المنتظمة",
