...
const translations = {
  en: {
    ...
    // PDF Merger Tool - English
    "pdfMerger.title": "PDF Merger",
    "pdfMerger.description": "Combine multiple PDF files into a single document. Drag and drop to reorder files.",
    "pdfMerger.uploadPdfFiles": "Upload PDF Files",
    "pdfMerger.dragDropOrClick": "Drag and drop PDF files here, or click to browse",
    "pdfMerger.chooseFiles": "Choose Files",
    "pdfMerger.mergePdfs": "Merge PDFs",
    ...
    "pdfSplitter.invalidFileType": "Invalid file type",
    "pdfSplitter.selectPdfFile": "Please select a PDF file",
    "pdfSplitter.fileTooLarge": "File too large",
    "pdfSplitter.fileSize100MB": "File exceeds 100MB limit",
    "pdfSplitter.inputRequired": "Input required",
    "pdfSplitter.specifyPages": "Please specify pages or ranges to extract",
    "pdfSplitter.invalidPageNumber": "Invalid page number",
    "pdfSplitter.pageNotValid": "Page",
    "pdfSplitter.pagesMustBeBetween": "Pages must be between",
    "pdfSplitter.and": "and",
    "pdfSplitter.invalidRange": "Invalid range",
    "pdfSplitter.uploadPdfFile": "Upload PDF File",
    "pdfSplitter.dragDropPdf": "Drag and drop a PDF file here, or click to browse",
    "pdfSplitter.chooseFile": "Choose File",
    "pdfSplitter.splitMethod": "Split Method",
    "pdfSplitter.splitPdf": "Split PDF",
    "pdfSplitter.splitting": "Splitting PDF...",
    "pdfSplitter.success": "Success!",
    "pdfSplitter.successMessage": "Successfully split PDF into {count} files",
    ...
    "pdfCompressor.description": "Reduce PDF file size while maintaining quality. Choose compression level based on your needs.",
    "pdfCompressor.uploadPdfFile": "Upload PDF File",
    "pdfCompressor.dragDropPdf": "Drag and drop a PDF file here, or click to browse",
    "pdfCompressor.chooseFile": "Choose File",
    "pdfCompressor.compressPdf": "Compress PDF",
    
    // PDF Converter Tool - English
    "pdfConverter.uploadFile": "Upload File",
    "pdfConverter.dragDrop": "Drag and drop a file here, or click to browse",
    ...
    "pdfConverter.converting": "Converting file...",
    "pdfConverter.convertFile": "Convert File",
    "pdfConverter.reset": "Reset",
    "pdfConverter.conversionComplete": "Conversion Complete!",
    "pdfConverter.readyForDownload": "File is ready for download",
    "pdfConverter.download": "Download",
    "pdfConverter.fileTooLarge": "File too large",
    "pdfConverter.fileSize100MB": "File exceeds 100MB limit",
    "pdfConverter.noFileSelected": "No file selected",
    "pdfConverter.selectFileFirst": "Please select a file first",
    "pdfConverter.noFormatSelected": "No format selected",
    "pdfConverter.selectConversionFormat": "Please select a conversion format",
    "pdfConverter.success": "Success!",
    "pdfConverter.conversionSuccessful": "File converted successfully",
    "pdfConverter.error": "Error",
    "pdfConverter.conversionFailed": "Failed to convert file",
    "pdfConverter.supportedFormats": "Supported formats: PDF, Word (DOC/DOCX), Excel (XLS/XLSX), Images (JPG/PNG/GIF/BMP)",
    
    // PDF Watermark Tool - English
    "pdfWatermark.title": "Add Watermark to PDF",
    "pdfWatermark.pdfFile": "PDF File",
    "pdfWatermark.clickToUpload": "Click to upload or drag and drop",
    "pdfWatermark.pdfFilesOnly": "PDF files only",
    "pdfWatermark.watermarkText": "Watermark Text",
    "pdfWatermark.enterWatermarkText": "Enter watermark text (e.g., CONFIDENTIAL, DRAFT, Company Name)",
    "pdfWatermark.watermarkAppliedDiagonally": "The watermark will be applied diagonally across each page",
    "pdfWatermark.addWatermark": "Add Watermark",
    
    // PDF Rotate Tool - English
    "pdfRotate.title": "Rotate PDF",
    "pdfRotate.pdfFile": "PDF File",
    "pdfRotate.clickToUpload": "Click to upload or drag and drop",
    "pdfRotate.pdfFilesOnly": "PDF files only",
    "pdfRotate.pageNumbers": "Page Numbers (optional)",
    "pdfRotate.pageNumbersPlaceholder": "e.g., 1,3,5 or leave empty for all pages",
    "pdfRotate.commaSeparatedNote": "Comma-separated page numbers. Leave empty to rotate all pages",
    "pdfRotate.rotationAngle": "Rotation Angle",
    "pdfRotate.clockwise90": "90° Clockwise",
    "pdfRotate.rotatePdf": "Rotate PDF",
    
    // PDF eSign Tool - English
    "pdfEsign.title": "Advanced eSign Tool",
    "pdfEsign.description": "Create digital signatures and manage document signing workflows",
    "pdfEsign.documentUpload": "Document Upload",
    "pdfEsign.uploadPdfDocuments": "Upload PDF Documents",
    "pdfEsign.clickToUploadOrDrag": "Click to upload or drag and drop your PDF file here",
    "pdfEsign.supportsPdfFiles": "Supports PDF files up to 10MB",
    "pdfEsign.documentSettings": "Document Settings",
    "pdfEsign.documentTitle": "Document Title",
    "pdfEsign.enterDocumentTitle": "Enter document title",
    "pdfEsign.messageToSigners": "Message to Signers",
    "pdfEsign.addMessageForSigners": "...Add a message for signers",
    "pdfEsign.signers": "Signers",
    "pdfEsign.addSigner": "Add Signer",
    "pdfEsign.createSignature": "Create Signature",
    "pdfEsign.draw": "Draw",
    "pdfEsign.type": "Type",
    "pdfEsign.aiGenerate": "AI Generate",
    "pdfEsign.yourName": "Your Name",
    "pdfEsign.enterYourFullName": "Enter your full name",
    "pdfEsign.signatureStyle": "Signature Style",
    "pdfEsign.cleanBusinessStyle": "Clean business style",
    "pdfEsign.professionalExecutive": "Professional Executive",
    "pdfEsign.generateAiSignature": "Generate AI Signature",
    
    // PDF Page Numbers Tool - English
    "pdfPageNumbers.title": "Add Page Numbers to PDF",
    "pdfPageNumbers.uploadPdf": "Upload PDF",
    "pdfPageNumbers.noFileChosen": "No file chosen",
    "pdfPageNumbers.chooseFile": "Choose File",
    
    // PDF Protection Tool - English
    "pdfProtection.title": "PDF Password Protection",
    "pdfProtection.description": "Secure your PDF documents with password protection and permission controls",
    "pdfProtection.uploadPdfFile": "Upload PDF File",
    "pdfProtection.dragDropPdf": "Drag and drop a PDF file here, or click to browse",
    "pdfProtection.chooseFile": "Choose File",
    "pdfProtection.protectPdf": "Protect PDF",
    "pdfProtection.securityTips": "Security Tips",
    "pdfProtection.useStrongPasswords": "Use strong passwords with a mix of letters, numbers, and symbols •",
    "pdfProtection.keepPasswordsSecure": "Keep your passwords secure and don't share them unnecessarily •",
    "pdfProtection.ownerPasswordControl": "The owner password provides additional control over document permissions •",
    "pdfProtection.considerDisablingPermissions": "Consider disabling permissions that aren't necessary for your use case •",
    ...
    "barcodeGenerator.copiedToClipboard": "Copied to Clipboard",
    "barcodeGenerator.barcodeImageCopied": "Barcode image copied to clipboard",
    "barcodeGenerator.unableToCopy": "Unable to copy to clipboard",
  ...
  es: {
    ...
    // Barcode Categories Spanish - Non-duplicate keys
    "barcodeCategory.linearCodes": "Códigos Lineales",
    "barcodeCategory.postalCodes": "Códigos Postales", 
    "barcodeCategory.gs1DataBar": "GS1 DataBar",
    "barcodeCategory.eanUpc": "EAN / UPC",
    "barcodeCategory.twoDCodes": "Códigos 2D",
    "barcodeCategory.gs1TwoDCodes": "Códigos GS1 2D",
    "barcodeCategory.bankingPayment": "Banca y Pagos",
    "barcodeCategory.mobileTags": "Etiquetas Móviles",
    "barcodeCategory.healthcareCodes": "Códigos de Salud",
    "barcodeCategory.isbnCodes": "Códigos ISBN",
    "barcodeCategory.businessCards": "Tarjetas de Negocio",
    "barcodeCategory.eventBarcodes": "Códigos de Eventos",
    "barcodeCategory.wifiBarcodes": "Códigos WiFi",

    // PDF Converter Format Options - Spanish
    "pdfFormat.pdfToWord": "PDF a Word",
    "pdfFormat.wordToPdf": "Word a PDF", 
    "pdfFormat.pdfToExcel": "PDF a Excel",
    "pdfFormat.excelToPdf": "Excel a PDF",
    "pdfFormat.pdfToImages": "PDF a Imágenes",
    "pdfFormat.imagesToPdf": "Imágenes a PDF",
    "pdfFormat.pdfToText": "PDF a Texto",
    "pdfFormat.pdfToHtml": "PDF a HTML",
    "pdfFormat.convertPdfToEditableWord": "Convertir PDF a documento Word editable",
    "pdfFormat.convertWordToPdf": "Convertir documento Word a PDF",
    "pdfFormat.extractTablesFromPdf": "Extraer tablas de PDF a hoja de cálculo Excel",
    "pdfFormat.convertExcelToPdf": "Convertir hoja de cálculo Excel a PDF",
    "pdfFormat.convertPdfPagesToImages": "Convertir páginas PDF a imágenes JPG/PNG",
    ...
    // PDF Merger Tool - Spanish
    "pdfMerger.title": "Fusionar PDF",
    "pdfMerger.description": "Combinar múltiples archivos PDF en un solo documento. Arrastra y suelta para reordenar archivos.",
    "pdfMerger.uploadPdfFiles": "Subir Archivos PDF",
    "pdfMerger.dragDropOrClick": "Arrastra y suelta archivos PDF aquí, o haz clic para navegar",
    "pdfMerger.chooseFiles": "Elegir Archivos",
    "pdfMerger.mergePdfs": "Fusionar PDFs",
    ...
    // PDF Splitter Tool - Spanish
    "pdfSplitter.title": "Divisor de PDF",
    "pdfSplitter.subtitle": "Extraer páginas específicas o rangos de documentos PDF",
    "pdfSplitter.specificPages": "Páginas Específicas",
    "pdfSplitter.pageRanges": "Rangos de Páginas",
    "pdfSplitter.everyNPages": "Cada N Páginas",
    "pdfSplitter.fixedSizeChunks": "Fragmentos de Tamaño Fijo",
    "pdfSplitter.invalidFileType": "Tipo de archivo inválido",
    "pdfSplitter.selectPdfFile": "Por favor selecciona un archivo PDF",
    "pdfSplitter.fileTooLarge": "Archivo demasiado grande",
    "pdfSplitter.fileSize100MB": "El archivo excede el límite de 100MB",
    "pdfSplitter.inputRequired": "Entrada requerida",
    "pdfSplitter.specifyPages": "Por favor especifica páginas o rangos a extraer",
    "pdfSplitter.invalidPageNumber": "Número de página inválido",
    "pdfSplitter.pageNotValid": "Página",
    "pdfSplitter.pagesMustBeBetween": "Las páginas deben estar entre",
    "pdfSplitter.and": "y",
    "pdfSplitter.invalidRange": "Rango inválido",
    "pdfSplitter.uploadPdfFile": "Subir Archivo PDF",
    "pdfSplitter.dragDropPdf": "Arrastra y suelta un archivo PDF aquí, o haz clic para navegar",
    "pdfSplitter.chooseFile": "Elegir Archivo",
    "pdfSplitter.splitMethod": "Método de División",
    "pdfSplitter.splitPdf": "Dividir PDF",
    "pdfSplitter.splitting": "Dividiendo PDF...",
    "pdfSplitter.success": "¡Éxito!",
    "pdfSplitter.successMessage": "PDF dividido exitosamente en {count} archivos",
    "pdfSplitter.error": "Error",
    "pdfSplitter.failedToSplit": "Error al dividir PDF",
    ...
    "pdfCompressor.description": "Reducir el tamaño del archivo PDF manteniendo la calidad. Elige el nivel de compresión según tus necesidades.",
    "pdfCompressor.uploadPdfFile": "Subir Archivo PDF",
    "pdfCompressor.dragDropPdf": "Arrastra y suelta un archivo PDF aquí, o haz clic para navegar",
    "pdfCompressor.chooseFile": "Elegir Archivo",
    "pdfCompressor.compressPdf": "Comprimir PDF",
    
    // PDF Converter Tool - Spanish
    "pdfConverter.uploadFile": "Subir Archivo",
    "pdfConverter.dragDrop": "Arrastra y suelta un archivo aquí, o haz clic para navegar",
    "pdfConverter.chooseFile": "Elegir Archivo",
    "pdfConverter.selectOutputFormat": "Seleccionar Formato de Salida",
    "pdfConverter.chooseConversionFormat": "Elegir formato de conversión",
    "pdfConverter.converting": "Convirtiendo archivo...",
    "pdfConverter.convertFile": "Convertir Archivo",
    "pdfConverter.reset": "Restablecer",
    "pdfConverter.conversionComplete": "¡Conversión Completa!",
    "pdfConverter.readyForDownload": "El archivo está listo para descargar",
    "pdfConverter.download": "Descargar",
    "pdfConverter.fileTooLarge": "Archivo demasiado grande",
    "pdfConverter.fileSize100MB": "El archivo excede el límite de 100MB",
    "pdfConverter.noFileSelected": "Ningún archivo seleccionado",
    "pdfConverter.selectFileFirst": "Por favor selecciona un archivo primero",
    "pdfConverter.noFormatSelected": "Ningún formato seleccionado",
    "pdfConverter.selectConversionFormat": "Por favor selecciona un formato de conversión",
    "pdfConverter.success": "¡Éxito!",
    "pdfConverter.conversionSuccessful": "Archivo convertido exitosamente",
    "pdfConverter.error": "Error",
    "pdfConverter.conversionFailed": "Error al convertir archivo",
    "pdfConverter.supportedFormats": "Formatos compatibles: PDF, Word (DOC/DOCX), Excel (XLS/XLSX), Imágenes (JPG/PNG/GIF/BMP)",
    
    // PDF Watermark Tool - Spanish
    "pdfWatermark.title": "Agregar Marca de Agua a PDF",
    "pdfWatermark.pdfFile": "Archivo PDF",
    "pdfWatermark.clickToUpload": "Haz clic para subir o arrastra y suelta",
    "pdfWatermark.pdfFilesOnly": "Solo archivos PDF",
    "pdfWatermark.watermarkText": "Texto de Marca de Agua",
    "pdfWatermark.enterWatermarkText": "Ingresa el texto de la marca de agua (ej., CONFIDENCIAL, BORRADOR, Nombre de la Empresa)",
    "pdfWatermark.watermarkAppliedDiagonally": "La marca de agua se aplicará diagonalmente en cada página",
    "pdfWatermark.addWatermark": "Agregar Marca de Agua",
    
    // PDF Rotate Tool - Spanish
    "pdfRotate.title": "Rotar PDF",
    "pdfRotate.pdfFile": "Archivo PDF",
    "pdfRotate.clickToUpload": "Haz clic para subir o arrastra y suelta",
    "pdfRotate.pdfFilesOnly": "Solo archivos PDF",
    "pdfRotate.pageNumbers": "Números de Página (opcional)",
    "pdfRotate.pageNumbersPlaceholder": "ej., 1,3,5 o dejar vacío para todas las páginas",
    "pdfRotate.commaSeparatedNote": "Números de página separados por comas. Dejar vacío para rotar todas las páginas",
    "pdfRotate.rotationAngle": "Ángulo de Rotación",
    "pdfRotate.clockwise90": "90° Sentido Horario",
    "pdfRotate.rotatePdf": "Rotar PDF",
    
    // PDF eSign Tool - Spanish
    "pdfEsign.title": "Herramienta de Firma Electrónica Avanzada",
    "pdfEsign.description": "Crear firmas digitales y gestionar flujos de trabajo de firma de documentos",
    "pdfEsign.documentUpload": "Subida de Documento",
    "pdfEsign.uploadPdfDocuments": "Subir Documentos PDF",
    "pdfEsign.clickToUploadOrDrag": "Haz clic para subir o arrastra y suelta tu archivo PDF aquí",
    "pdfEsign.supportsPdfFiles": "Soporta archivos PDF de hasta 10MB",
    "pdfEsign.documentSettings": "Configuración del Documento",
    "pdfEsign.documentTitle": "Título del Documento",
    "pdfEsign.enterDocumentTitle": "Ingresa el título del documento",
    "pdfEsign.messageToSigners": "Mensaje para Firmantes",
    "pdfEsign.addMessageForSigners": "...Agrega un mensaje para los firmantes",
    "pdfEsign.signers": "Firmantes",
    "pdfEsign.addSigner": "Agregar Firmante",
    "pdfEsign.createSignature": "Crear Firma",
    "pdfEsign.draw": "Dibujar",
    "pdfEsign.type": "Escribir",
    "pdfEsign.aiGenerate": "Generar con IA",
    "pdfEsign.yourName": "Tu Nombre",
    "pdfEsign.enterYourFullName": "Ingresa tu nombre completo",
    "pdfEsign.signatureStyle": "Estilo de Firma",
    "pdfEsign.cleanBusinessStyle": "Estilo empresarial limpio",
    "pdfEsign.professionalExecutive": "Ejecutivo Profesional",
    "pdfEsign.generateAiSignature": "Generar Firma con IA",
    
    // PDF Page Numbers Tool - Spanish
    "pdfPageNumbers.title": "Agregar Números de Página a PDF",
    "pdfPageNumbers.uploadPdf": "Subir PDF",
    "pdfPageNumbers.noFileChosen": "Ningún archivo seleccionado",
    "pdfPageNumbers.chooseFile": "Elegir Archivo",
    
    // PDF Protection Tool - Spanish
    "pdfProtection.title": "Protección con Contraseña PDF",
    "pdfProtection.description": "Protege tus documentos PDF con protección por contraseña y controles de permisos",
    "pdfProtection.uploadPdfFile": "Subir Archivo PDF",
    "pdfProtection.dragDropPdf": "Arrastra y suelta un archivo PDF aquí, o haz clic para navegar",
    "pdfProtection.chooseFile": "Elegir Archivo",
    "pdfProtection.protectPdf": "Proteger PDF",
    "pdfProtection.securityTips": "Consejos de Seguridad",
    "pdfProtection.useStrongPasswords": "Usa contraseñas fuertes con una mezcla de letras, números y símbolos •",
    "pdfProtection.keepPasswordsSecure": "Mantén tus contraseñas seguras y no las compartas innecesariamente •",
    "pdfProtection.ownerPasswordControl": "La contraseña del propietario proporciona control adicional sobre los permisos del documento •",
    "pdfProtection.considerDisablingPermissions": "Considera deshabilitar los permisos que no son necesarios para tu caso de uso •",
    ...
    // Barcode Generator Tool - Spanish
    ...
    "barcodeGenerator.svgFeature": "Función SVG",
    "barcodeGenerator.svgFeatureDesc": "La descarga SVG se implementará en la próxima actualización. La descarga PNG está completamente funcional.",
    "barcodeGenerator.copiedToClipboard": "Copiado al Portapapeles",
    "barcodeGenerator.barcodeImageCopied": "Imagen del código de barras copiada al portapapeles",
    "barcodeGenerator.unableToCopy": "No se pudo copiar al portapapeles",
  ...
  ar: {
    ...
    // Barcode Categories - Arabic
    "barcode.linearCodes": "الأكواد الخطية",
    "barcode.postalCodes": "الأكواد البريدية", 
    "barcode.gs1DataBar": "GS1 DataBar",
    "barcode.eanUpc": "EAN / UPC",
    "barcode.twoDCodes": "الأكواد ثنائية الأبعاد",
    "barcode.gs1TwoDCodes": "أكواد GS1 ثنائية الأبعاد",
    "barcode.bankingPayment": "البنوك والمدفوعات",
    "barcode.mobileTags": "العلامات المحمولة",
    "barcode.healthcare": "أكواد الرعاية الصحية",
    "barcode.isbn": "أكواد ISBN",
    "barcode.businessCards": "بطاقات العمل",
    "barcode.events": "أكواد الأحداث",
    "barcode.wifi": "أكواد الواي فاي",

    // Barcode Types - Arabic
    "barcode.code128": "كود-128",
    "barcode.code11": "كود-11",
    "barcode.code2of5Interleaved": "كود-2of5 متداخل",
    "barcode.code39": "كود-39",
    "barcode.code39FullAscii": "كود-39 ASCII كامل",
    "barcode.code93": "كود-93",
    "barcode.ean8": "EAN-8",
    "barcode.ean13": "EAN-13",
    "barcode.upcA": "UPC-A",
    "barcode.upcE": "UPC-E",
    "barcode.dataMatrix": "مصفوفة البيانات",
    "barcode.qrCode": "رمز QR",
    "barcode.pdf417": "PDF417",
    "barcode.aztecCode": "كود أزتيك",
    "barcode.maxiCode": "ماكسي كود",

    // Barcode Categories Arabic - Non-duplicate keys
    "barcodeCategory.linearCodes": "الأكواد الخطية",
    "barcodeCategory.postalCodes": "الأكواد البريدية", 
    "barcodeCategory.gs1DataBar": "GS1 DataBar",
    "barcodeCategory.eanUpc": "EAN / UPC",
    "barcodeCategory.twoDCodes": "الأكواد ثنائية الأبعاد",
    "barcodeCategory.gs1TwoDCodes": "أكواد GS1 ثنائية الأبعاد",
    "barcodeCategory.bankingPayment": "البنوك والمدفوعات",
    "barcodeCategory.mobileTags": "العلامات المحمولة",
    "barcodeCategory.healthcareCodes": "أكواد الرعاية الصحية",
    "barcodeCategory.isbnCodes": "أكواد ISBN",
    "barcodeCategory.businessCards": "بطاقات العمل",
    "barcodeCategory.eventBarcodes": "أكواد الأحداث",
    "barcodeCategory.wifiBarcodes": "أكواد الواي فاي",

    // PDF Converter Format Options - Arabic
    "pdfFormat.pdfToWord": "PDF إلى Word",
    "pdfFormat.wordToPdf": "Word إلى PDF", 
    "pdfFormat.pdfToExcel": "PDF إلى Excel",
    "pdfFormat.excelToPdf": "Excel إلى PDF",
    "pdfFormat.pdfToImages": "PDF إلى صور",
    "pdfFormat.imagesToPdf": "صور إلى PDF",
    "pdfFormat.pdfToText": "PDF إلى نص",
    "pdfFormat.pdfToHtml": "PDF إلى HTML",
    "pdfFormat.convertPdfToEditableWord": "تحويل PDF إلى مستند Word قابل للتحرير",
    "pdfFormat.convertWordToPdf": "تحويل مستند Word إلى PDF",
    "pdfFormat.extractTablesFromPdf": "استخراج الجداول من PDF إلى جدول بيانات Excel",
    "pdfFormat.convertExcelToPdf": "تحويل جدول بيانات Excel إلى PDF",
    "pdfFormat.convertPdfPagesToImages": "تحويل صفحات PDF إلى صور JPG/PNG",
    "pdfFormat.combineImagesIntoPdf": "دمج صور متعددة في PDF",
    ...
    // PDF Merger Tool - Arabic
    "pdfMerger.title": "دمج PDF",
    "pdfMerger.description": "دمج ملفات PDF متعددة في مستند واحد. اسحب وأفلت لإعادة ترتيب الملفات.",
    "pdfMerger.uploadPdfFiles": "رفع ملفات PDF",
    "pdfMerger.dragDropOrClick": "اسحب وأفلت ملفات PDF هنا، أو انقر للتصفح",
    "pdfMerger.chooseFiles": "اختر الملفات",
    "pdfMerger.mergePdfs": "دمج ملفات PDF",
    ...
    "pdfConverter.converting": "جارٍ تحويل الملف...",
    "pdfConverter.convertFile": "تحويل الملف",
    "pdfConverter.reset": "إعادة تعيين",
    "pdfConverter.conversionComplete": "اكتمل التحويل!",
    "pdfConverter.readyForDownload": "الملف جاهز للتحميل",
    "pdfConverter.download": "تحميل",
    "pdfConverter.fileTooLarge": "الملف كبير جداً",
    "pdfConverter.fileSize100MB": "الملف يتجاوز حد 100 ميجابايت",
    "pdfConverter.noFileSelected": "لم يتم اختيار ملف",
    "pdfConverter.selectFileFirst": "يرجى اختيار ملف أولاً",
    "pdfConverter.noFormatSelected": "لم يتم اختيار تنسيق",
    "pdfConverter.selectConversionFormat": "يرجى اختيار تنسيق التحويل",
    "pdfConverter.success": "نجح!",
    "pdfConverter.conversionSuccessful": "تم تحويل الملف بنجاح",
    "pdfConverter.error": "خطأ",
    "pdfConverter.conversionFailed": "فشل في تحويل الملف",
    ...
    "pdfWatermark.pdfFile": "ملف PDF",
    "pdfWatermark.clickToUpload": "انقر للرفع أو اسحب وأفلت",
    "pdfWatermark.pdfFilesOnly": "ملفات PDF فقط",
    "pdfWatermark.watermarkText": "نص العلامة المائية",
    "pdfWatermark.enterWatermarkText": "أدخل نص العلامة المائية (مثل: سري، مسودة، اسم الشركة)",
    "pdfWatermark.watermarkAppliedDiagonally": "ستطبق العلامة المائية قطرياً عبر كل صفحة",
    "pdfWatermark.addWatermark": "إضافة علامة مائية",
    
    // PDF Rotate Tool - Arabic
    "pdfRotate.title": "تدوير PDF",
    "pdfRotate.pdfFile": "ملف PDF",
    "pdfRotate.clickToUpload": "انقر للرفع أو اسحب وأفلت",
    "pdfRotate.pdfFilesOnly": "ملفات PDF فقط",
    "pdfRotate.pageNumbers": "أرقام الصفحات (اختياري)",
    "pdfRotate.pageNumbersPlaceholder": "مثل: 1،3،5 أو اتركه فارغاً لجميع الصفحات",
    "pdfRotate.commaSeparatedNote": "أرقام الصفحات مفصولة بفواصل. اتركه فارغاً لتدوير جميع الصفحات",
    "pdfRotate.rotationAngle": "زاوية التدوير",
    "pdfRotate.clockwise90": "90° مع عقارب الساعة",
    "pdfRotate.rotatePdf": "تدوير PDF",
    
    // PDF eSign Tool - Arabic
    "pdfEsign.title": "أداة التوقيع الإلكتروني المتقدمة",
    "pdfEsign.description": "إنشاء التوقيعات الرقمية وإدارة سير عمل توقيع المستندات",
    "pdfEsign.documentUpload": "رفع المستند",
    "pdfEsign.uploadPdfDocuments": "رفع مستندات PDF",
    "pdfEsign.clickToUploadOrDrag": "انقر للرفع أو اسحب وأفلت ملف PDF الخاص بك هنا",
    "pdfEsign.supportsPdfFiles": "يدعم ملفات PDF حتى 10 ميجابايت",
    "pdfEsign.documentSettings": "إعدادات المستند",
    "pdfEsign.documentTitle": "عنوان المستند",
    "pdfEsign.enterDocumentTitle": "أدخل عنوان المستند",
    "pdfEsign.messageToSigners": "رسالة للموقعين",
    "pdfEsign.addMessageForSigners": "...أضف رسالة للموقعين",
    "pdfEsign.signers": "الموقعون",
    "pdfEsign.addSigner": "إضافة موقع",
    "pdfEsign.createSignature": "إنشاء توقيع",
    "pdfEsign.draw": "رسم",
    "pdfEsign.type": "كتابة",
    "pdfEsign.aiGenerate": "توليد بالذكاء الاصطناعي",
    "pdfEsign.yourName": "اسمك",
    "pdfEsign.enterYourFullName": "أدخل اسمك الكامل",
    "pdfEsign.signatureStyle": "نمط التوقيع",
    "pdfEsign.cleanBusinessStyle": "نمط تجاري نظيف",
    "pdfEsign.professionalExecutive": "تنفيذي محترف",
    "pdfEsign.generateAiSignature": "توليد توقيع بالذكاء الاصطناعي",
    
    // PDF Page Numbers Tool - Arabic
    "pdfPageNumbers.title": "إضافة أرقام الصفحات لـ PDF",
    "pdfPageNumbers.uploadPdf": "رفع PDF",
    "pdfPageNumbers.noFileChosen": "لم يتم اختيار ملف",
    "pdfPageNumbers.chooseFile": "اختر الملف",
    
    // PDF Protection Tool - Arabic
    "pdfProtection.title": "حماية PDF بكلمة مرور",
    "pdfProtection.description": "حماية مستندات PDF الخاصة بك بحماية كلمة المرور وضوابط الأذونات",
    "pdfProtection.uploadPdfFile": "رفع ملف PDF",
    "pdfProtection.dragDropPdf": "اسحب وأفلت ملف PDF هنا، أو انقر للتصفح",
    "pdfProtection.chooseFile": "اختر الملف",
    "pdfProtection.protectPdf": "حماية PDF",
    "pdfProtection.securityTips": "نصائح الأمان",
    "pdfProtection.useStrongPasswords": "استخدم كلمات مرور قوية مع مزيج من الحروف والأرقام والرموز •",
    "pdfProtection.keepPasswordsSecure": "حافظ على أمان كلمات المرور ولا تشاركها دون ضرورة •",
    "pdfProtection.ownerPasswordControl": "كلمة مرور المالك توفر تحكماً إضافياً في أذونات المستند •",
    "pdfProtection.considerDisablingPermissions": "فكر في تعطيل الأذونات غير الضرورية لحالة الاستخدام الخاصة بك •",
    ...
    "barcodeGenerator.loadSample": "تحميل بيانات العينة",
    ...
    "barcodeGenerator.copiedToClipboard": "تم النسخ إلى الحافظة", 
    "barcodeGenerator.barcodeImageCopied": "تم نسخ صورة الباركود إلى الحافظة",
    "barcodeGenerator.unableToCopy": "تعذر النسخ إلى الحافظة",
    ...
    // Duplicate barcode categories removed - using organized sections above
