...
const translations = {
  en: {
    ...
    "tools.ai-text-detector": "AI Text Detector",
    "tools.ai-text-detector.desc": "Detect if text was generated by AI",
    "tools.ai-text-humanizer": "AI Text Humanizer",
    "tools.ai-text-humanizer.desc": "Make AI-generated text sound more human",
    ...
    // AI Text Tool
    "aiTextTool.title": "AI Text Detector & Humanizer",
    "aiTextTool.subtitle": "Detect AI-generated text and humanize content for natural reading",
    "aiTextTool.aiDetector": "AI Detector",
    "aiTextTool.aiHumanizer": "AI Humanizer",
    "aiTextTool.inputText": "Input Text",
    "aiTextTool.detectPlaceholder": "Paste text here to analyze if it was generated by AI...",
    "aiTextTool.humanizePlaceholder": "Paste AI-generated text here to make it sound more human...",
    "aiTextTool.characters": "characters",
    "aiTextTool.reset": "Reset",
    "aiTextTool.detecting": "Analyzing...",
    "aiTextTool.humanizing": "Humanizing...",
    "aiTextTool.detectText": "Detect AI Text",
    "aiTextTool.humanizeText": "Humanize Text",
    "aiTextTool.analyzingText": "Analyzing text patterns and language markers...",
    "aiTextTool.processingText": "Processing and improving text naturalness...",
    "aiTextTool.detectionResults": "Detection Results",
    "aiTextTool.humanizedText": "Humanized Text",
    "aiTextTool.likelyAI": "Likely AI-Generated",
    "aiTextTool.likelyHuman": "Likely Human-Written",
    "aiTextTool.confidence": "Confidence",
    "aiTextTool.analysis": "Analysis",
    "aiTextTool.indicators": "Key Indicators",
    "aiTextTool.readabilityScore": "Readability Score",
    "aiTextTool.improvedText": "Improved Text",
    "aiTextTool.changesApplied": "Changes Applied",
    "aiTextTool.copy": "Copy",
    "aiTextTool.error": "Error",
    "aiTextTool.enterTextFirst": "Please enter text to analyze",
    "aiTextTool.detectionComplete": "Detection Complete",
    "aiTextTool.detectionCompleteDesc": "AI text analysis has been completed successfully",
    "aiTextTool.detectionFailed": "Detection Failed",
    "aiTextTool.detectionFailedDesc": "Failed to analyze text. Please try again.",
    "aiTextTool.humanizationComplete": "Humanization Complete",
    "aiTextTool.humanizationCompleteDesc": "Text has been successfully humanized",
    "aiTextTool.humanizationFailed": "Humanization Failed", 
    "aiTextTool.humanizationFailedDesc": "Failed to humanize text. Please try again.",
    "aiTextTool.copied": "Copied",
    "aiTextTool.copiedDesc": "Text copied to clipboard",
    "aiTextTool.copyFailed": "Copy Failed",
    "aiTextTool.copyFailedDesc": "Failed to copy text to clipboard",
  },
  es: {
    // Header
    "header.title": "Aptexa ToolHub",
    ...
    "tools.ai-text-detector": "Detector de Texto IA",
    "tools.ai-text-detector.desc": "Detectar si el texto fue generado por IA",
    "tools.ai-text-humanizer": "Humanizador de Texto IA",
    "tools.ai-text-humanizer.desc": "Hacer que el texto generado por IA suene más humano",
    ...
    // AI Text Tool
    "aiTextTool.title": "Detector y Humanizador de Texto IA",
    "aiTextTool.subtitle": "Detecta texto generado por IA y humaniza contenido para lectura natural",
    "aiTextTool.aiDetector": "Detector IA",
    "aiTextTool.aiHumanizer": "Humanizador IA",
    "aiTextTool.inputText": "Texto de Entrada",
    "aiTextTool.detectPlaceholder": "Pega texto aquí para analizar si fue generado por IA...",
    "aiTextTool.humanizePlaceholder": "Pega texto generado por IA aquí para hacerlo sonar más humano...",
    "aiTextTool.characters": "caracteres",
    "aiTextTool.reset": "Reiniciar",
    "aiTextTool.detecting": "Analizando...",
    "aiTextTool.humanizing": "Humanizando...",
    "aiTextTool.detectText": "Detectar Texto IA",
    "aiTextTool.humanizeText": "Humanizar Texto",
    "aiTextTool.analyzingText": "Analizando patrones de texto y marcadores de lenguaje...",
    "aiTextTool.processingText": "Procesando y mejorando la naturalidad del texto...",
    "aiTextTool.detectionResults": "Resultados de Detección",
    "aiTextTool.humanizedText": "Texto Humanizado",
    "aiTextTool.likelyAI": "Probablemente Generado por IA",
    "aiTextTool.likelyHuman": "Probablemente Escrito por Humano",
    "aiTextTool.confidence": "Confianza",
    "aiTextTool.analysis": "Análisis",
    "aiTextTool.indicators": "Indicadores Clave",
    "aiTextTool.readabilityScore": "Puntuación de Legibilidad",
    "aiTextTool.improvedText": "Texto Mejorado",
    "aiTextTool.changesApplied": "Cambios Aplicados",
    "aiTextTool.copy": "Copiar",
    "aiTextTool.error": "Error",
    "aiTextTool.enterTextFirst": "Por favor ingresa texto para analizar",
    "aiTextTool.detectionComplete": "Detección Completada",
    "aiTextTool.detectionCompleteDesc": "El análisis de texto IA se ha completado exitosamente",
    "aiTextTool.detectionFailed": "Detección Fallida",
    "aiTextTool.detectionFailedDesc": "Fallo al analizar el texto. Inténtalo de nuevo.",
    "aiTextTool.humanizationComplete": "Humanización Completada",
    "aiTextTool.humanizationCompleteDesc": "El texto ha sido humanizado exitosamente",
    "aiTextTool.humanizationFailed": "Humanización Fallida",
    "aiTextTool.humanizationFailedDesc": "Fallo al humanizar el texto. Inténtalo de nuevo.",
    "aiTextTool.copied": "Copiado",
    "aiTextTool.copiedDesc": "Texto copiado al portapapeles",
    "aiTextTool.copyFailed": "Fallo al Copiar",
    "aiTextTool.copyFailedDesc": "Fallo al copiar texto al portapapeles",
  },
  ar: {
    // Header
    "header.title": "Aptexa ToolHub",
    ...
    "tools.ai-text-detector": "كاشف النص بالذكاء الاصطناعي",
    "tools.ai-text-detector.desc": "اكتشاف ما إذا كان النص مُولد بالذكاء الاصطناعي",
    "tools.ai-text-humanizer": "مُنسن النص بالذكاء الاصطناعي",
    "tools.ai-text-humanizer.desc": "جعل النص المُولد بالذكاء الاصطناعي يبدو أكثر طبيعية",
    ...
    "dataMatrix.subtitle": "إنشاء رموز Data Matrix عالية الكثافة",
    "dataMatrix.alphanumericOrNumeric": "أرقام وحروف أو كل الرقمية",
    "dataMatrix.highDensity": "كثافة عالية",
    
    // Code 128 Specific  
    "code128.title": "مولد Code 128",
    "code128.subtitle": "إنشاء باركود اختياري، جودة عالية",
    "code128.linearCodes": "رموز خطية",
    ...
    // AI Text Tool
    "aiTextTool.title": "كاشف ومُنسن النص بالذكاء الاصطناعي",
    "aiTextTool.subtitle": "اكتشف النص المُولد بالذكاء الاصطناعي واجعل المحتوى أكثر طبيعية",
    "aiTextTool.aiDetector": "كاشف الذكاء الاصطناعي",
    "aiTextTool.aiHumanizer": "مُنسن الذكاء الاصطناعي",
    "aiTextTool.inputText": "النص المدخل",
    "aiTextTool.detectPlaceholder": "الصق النص هنا لتحليل ما إذا كان مُولداً بالذكاء الاصطناعي...",
    "aiTextTool.humanizePlaceholder": "الصق النص المُولد بالذكاء الاصطناعي هنا لجعله يبدو أكثر طبيعية...",
    "aiTextTool.characters": "حرف",
    "aiTextTool.reset": "إعادة تعيين",
    "aiTextTool.detecting": "جاري التحليل...",
    "aiTextTool.humanizing": "جاري التنسين...",
    "aiTextTool.detectText": "كشف النص بالذكاء الاصطناعي",
    "aiTextTool.humanizeText": "تنسين النص",
    "aiTextTool.analyzingText": "تحليل أنماط النص وعلامات اللغة...",
    "aiTextTool.processingText": "معالجة وتحسين طبيعية النص...",
    "aiTextTool.detectionResults": "نتائج الكشف",
    "aiTextTool.humanizedText": "النص المُنسن",
    "aiTextTool.likelyAI": "محتمل أن يكون مُولد بالذكاء الاصطناعي",
    "aiTextTool.likelyHuman": "محتمل أن يكون مكتوب بواسطة إنسان",
    "aiTextTool.confidence": "الثقة",
    "aiTextTool.analysis": "التحليل",
    "aiTextTool.indicators": "المؤشرات الرئيسية",
    "aiTextTool.readabilityScore": "نقاط القابلية للقراءة",
    "aiTextTool.improvedText": "النص المحسن",
    "aiTextTool.changesApplied": "التغييرات المطبقة",
    "aiTextTool.copy": "نسخ",
    "aiTextTool.error": "خطأ",
    "aiTextTool.enterTextFirst": "يرجى إدخال نص للتحليل",
    "aiTextTool.detectionComplete": "اكتمل الكشف",
    "aiTextTool.detectionCompleteDesc": "تم إكمال تحليل النص بالذكاء الاصطناعي بنجاح",
    "aiTextTool.detectionFailed": "فشل الكشف",
    "aiTextTool.detectionFailedDesc": "فشل في تحليل النص. يرجى المحاولة مرة أخرى.",
    "aiTextTool.humanizationComplete": "اكتمل التنسين",
    "aiTextTool.humanizationCompleteDesc": "تم تنسين النص بنجاح",
    "aiTextTool.humanizationFailed": "فشل التنسين",
    "aiTextTool.humanizationFailedDesc": "فشل في تنسين النص. يرجى المحاولة مرة أخرى.",
    "aiTextTool.copied": "تم النسخ",
    "aiTextTool.copiedDesc": "تم نسخ النص إلى الحافظة",
    "aiTextTool.copyFailed": "فشل النسخ",
    "aiTextTool.copyFailedDesc": "فشل في نسخ النص إلى الحافظة",
