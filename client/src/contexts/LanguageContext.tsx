...
const translations = {
  ...
  ar: {
    ...
    "jsonFormatter.subtitle": "تنسيق والتحقق من صحة وضغط بيانات JSON",
    "jsonFormatter.inputJson": "JSON المدخل",
    "jsonFormatter.enterJson": "أدخل JSON هنا...",
    "jsonFormatter.formatJson": "تنسيق JSON",
    "jsonFormatter.validateJson": "التحقق من صحة JSON",
    "jsonFormatter.minifyJson": "ضغط JSON",
    "jsonFormatter.beautifyJson": "تجميل JSON",
    "jsonFormatter.sortKeys": "ترتيب المفاتيح",
    "jsonFormatter.indentSize": "حجم المسافة البادئة",
    "jsonFormatter.formattedJson": "JSON المنسق",
    "jsonFormatter.validJson": "JSON صالح",
    "jsonFormatter.invalidJson": "JSON غير صالح",
