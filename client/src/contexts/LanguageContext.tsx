...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "dashboard.benefits.title": "Why Choose Our Tools?",
    "dashboard.benefits.document.title": "Document Processing",
    "dashboard.benefits.document.description1": "Professional PDF tools for merging, splitting, and editing documents",
    "dashboard.benefits.document.description2": "Advanced signature capabilities with legal compliance",
    "dashboard.benefits.developer.title": "Developer Utilities",
    "dashboard.benefits.developer.description1": "Code formatting, API testing, and development tools",
    "dashboard.benefits.developer.description2": "Regex testing, JWT decoding, and minification tools",
    "dashboard.features.title": "Key Features",
    "dashboard.features.secure": "Secure & Private",
    "dashboard.features.secureDesc": "All processing happens locally in your browser",
    "dashboard.features.fast": "Lightning Fast",
    "dashboard.features.fastDesc": "Optimized algorithms for quick results",
    "dashboard.features.mobile": "Mobile Friendly",
    "dashboard.features.mobileDesc": "Works perfectly on all devices and screen sizes",
    "dashboard.tools.overview.title": "Tool Categories",
    ...
    "dashboard.tools.barcodeDesc": "Generate various barcode formats",
    "dashboard.tools.qrcode": "QR Code Generator",
    "dashboard.tools.qrcodeDesc": "Create custom QR codes with logos",
    "dashboard.tools.signature": "Digital Signature",
    "dashboard.tools.signatureDesc": "Create and apply digital signatures",
    "dashboard.tools.pdfsign": "PDF E-Sign",
    "dashboard.tools.pdfsignDesc": "Electronically sign PDF documents",
    "dashboard.tools.developer.title": "Developer Tools",
    "dashboard.tools.regex": "Regex Tester",
    "dashboard.tools.regexDesc": "Test and validate regular expressions",
    "dashboard.tools.jwt": "JWT Decoder",
    "dashboard.tools.jwtDesc": "Decode and verify JSON Web Tokens",
    "dashboard.tools.api": "API Tester",
    "dashboard.tools.apiDesc": "Test REST API endpoints easily",
    "dashboard.tools.cssmin": "CSS Minifier",
    "dashboard.tools.cssminDesc": "Minify and optimize CSS code",
    ...
    "dashboard.tools.imagecompDesc": "Reduce image file sizes efficiently",
    "dashboard.tools.pdfmerge": "PDF Merger",
    "dashboard.tools.pdfmergeDesc": "Combine multiple PDF files",
    "dashboard.tools.textconv": "Text Converter",
    "dashboard.tools.textconvDesc": "Convert between text formats",
    "dashboard.tools.colorconv": "Color Converter",
    "dashboard.tools.colorconvDesc": "Convert between color formats",
    "dashboard.tools.password": "Password Generator",
    "dashboard.tools.passwordDesc": "Generate secure passwords",
    "dashboard.security.title": "Security & Privacy",
    "dashboard.security.protection.title": "Data Protection",
    "dashboard.security.protection.description": "Your files never leave your device - all processing is done locally",
    "footer.privacyPolicy": "Privacy Policy",
    "footer.enterpriseStandards": "Enterprise Standards",
    "footer.securityCompliance": "Security Compliance",
    "footer.professionalCompliance": "Professional Compliance",
    "footer.regularAudits": "Regular Security Audits",
